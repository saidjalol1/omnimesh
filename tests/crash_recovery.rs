...
fn test_delivery_under_memory_pressure() {
    ...
    println!("Delivered: {}, Duplicates detected: {}", delivered, duplicates);
...
fn test_graceful_degradation() {
    ...
    println!("Graceful degradation: success={}, errors={}", success_count, error_count);
...
fn test_concurrent_delivery() {
    ...
    println!("Concurrent delivery: {} messages delivered across 4 threads", total_delivered);
